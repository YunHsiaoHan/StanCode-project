...
def make_gui(top, width, height, names, draw_names, search_names):
    ...
    entry = tkinter.Entry(top, width=40, name='entry', borderwidth=2) #輸入文字的地方
    ...
    entry.bind("<Return>", lambda event: handle_draw(entry, canvas, names, error_out, draw_names)) # 按下enter鍵之後要做的事
